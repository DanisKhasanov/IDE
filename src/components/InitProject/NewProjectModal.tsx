...
import { BoardSelectionPanel } from "./sections/BoardSelectionPanel";
import { SelectedPinsPanel } from "./sections/SelectedPinsPanel";
import { PinsListPanel } from "./sections/PinsListPanel";
...
const NewProjectModal: React.FC<NewProjectModalProps> = ({
  ...
  const handleFunctionSelect = (
    ...
    // Добавляем новую функцию к существующим
